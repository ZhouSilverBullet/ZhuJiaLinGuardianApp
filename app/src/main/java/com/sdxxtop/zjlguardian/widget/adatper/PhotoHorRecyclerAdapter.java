package com.sdxxtop.zjlguardian.widget.adatper;
...
public class PhotoHorRecyclerAdapter extends BaseQuickAdapter<LocalMedia, BaseViewHolder> {

    public PhotoHorRecyclerAdapter(int layoutResId) {
        super(layoutResId);
    }
