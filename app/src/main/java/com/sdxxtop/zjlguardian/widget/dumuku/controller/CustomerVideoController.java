package com.sdxxtop.zjlguardian.widget.dumuku.controller;
...
public class CustomerVideoController extends GestureVideoController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private EditText edDanmuku;
    private CheckBox cbDanmuku;


    public CustomerVideoController(@NonNull Context context) {
        this(context, null);
    }

    public CustomerVideoController(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomerVideoController(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.dkplayer_layout_customer_controller;
    }
    ...
    protected void initView() {
        ...
        tvSend = mControllerView.findViewById(R.id.tv_send);
        tvSend.setOnClickListener(this);
        edDanmuku = mControllerView.findViewById(R.id.et_danmuku);
        cbDanmuku = mControllerView.findViewById(R.id.cb_danmuku);
        cbDanmuku.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (mDanmukuShowCallback != null) {
                    mDanmukuShowCallback.onShow(isChecked);
                }
            }
        });
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.fullscreen || i == R.id.back) {
            ...
            String etValue = edDanmuku.getText().toString();
            if (mDanmukuSendCallback != null) {
                mDanmukuSendCallback.onSend(etValue);
            }
        }
    }
...
//                mLoadingProgress.setVisibility(GONE);
    ...
    private DanmukuSendCallback mDanmukuSendCallback;

    public void setDanmukuSendCallback(DanmukuSendCallback danmukuSendCallback) {
        mDanmukuSendCallback = danmukuSendCallback;
    }

    public interface DanmukuSendCallback {
        void onSend(String value);
    }

    private DanmukuShowCallback mDanmukuShowCallback;

    public void setDanmukuShowCallback(DanmukuShowCallback danmukuShowCallback) {
        mDanmukuShowCallback = danmukuShowCallback;
    }

    public interface DanmukuShowCallback {
